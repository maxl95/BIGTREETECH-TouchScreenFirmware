This is my fork of BigTreeTechs TFT Firmware. I own a TFT24 V1.1. I've added a custom menu page for custom gcode commands with custom icons and a four-point Bed Leveling Page.
